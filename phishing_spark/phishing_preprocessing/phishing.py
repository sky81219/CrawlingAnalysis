...
class PhishingPreprocessing:
    ...
    def path_entropy(self):
        ...
        path_prob = [float(string.count(c)) / len(string) for c in dict.fromkeys(list(string))]
    ...
    def google_index(self):
        try:
            ...
            return 1 if site else -1
                ...
                requests.exceptions.TooManyRedirects, URLError, requests.exceptions.InvalidSchema):
            return -1
